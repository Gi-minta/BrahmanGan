...
/// <summary>Catálogo de controles preventivos (vacunación rutinaria, baños, etc.).</summary>
public sealed class ControlPreventivo : Entity<ControlPreventivoId>
{
    ...
    {
        if (string.IsNullOrWhiteSpace(nombre)) throw new DomainException("Nombre requerido");
        return new ControlPreventivo { Id = ControlPreventivoId.New(), Nombre = nombre.Trim(), Periodicidad = periodicidad, Descripcion = descripcion };
    }
}
